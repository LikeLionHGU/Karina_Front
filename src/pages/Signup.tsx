...
// handlers
  ...
  isActive === 'fisher'
    ...
    : isActive === 'factory'? '사업자 등록증 또는 공장등록 증명서를 업로드 해주세요.'
      : '파일 또는 사진을 업로드 해주세요.';
  ...
  const onSubmitFile: React.MouseEventHandler<HTMLButtonElement> = async (event) => {
  ...
  return (
    <>
      ...
      <button className={styles.next} onClick = {onSubmitFile}>다음</button>
    </>
